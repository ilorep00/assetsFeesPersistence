...
public class FinancialProductHandler implements Handler {
	...
	public void setLoanIdentification(LoanIdentificationNumberCode loanIdentification){
		this.loanIdentification = loanIdentification;
	}
	
	public LoanIdentificationNumberCode getLoanIdentification(){
		return this.loanIdentification;
	}
}
